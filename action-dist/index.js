...
const app_error_1 = __nccwpck_require__(785);
class EnumUtil {
    constructor() {
        throw new app_error_1.AppError('Class cannot be instantiated');
    }
    static getEnumKeyByEnumValue(enumClass, value) {
        var _a;
        const objValues = Object.values(enumClass);
        const objKeys = Object.keys(enumClass);
        return (_a = objKeys.find((x, index) => objValues[index] === value)) !== null && _a !== void 0 ? _a : '';
    }
}
...
const enum_util_1 = __nccwpck_require__(483);
const parser_input_model_1 = __nccwpck_require__(798);
try {
    ...
    console.log(enum_util_1.EnumUtil.getEnumKeyByEnumValue(parser_input_model_1.AvailableLanguageEnum, 'java'));
}
catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AvailableDependencyManagementToolsEnum = exports.AvailableLanguageEnum = void 0;
